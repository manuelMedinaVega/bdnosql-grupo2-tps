...
def inicializar(conn):
    ...
    # crear db
    cassandra_session.execute('DROP TABLE IF EXISTS ej01')
    cassandra_session.execute('CREATE TABLE IF NOT EXISTS tp3.ej01 (id_deportista INT, nombre_deportista text, Primary Key(id_deportista));')
...
def procesar_fila(db, fila):
    ...
    query = "INSERT INTO ej01 (id_deportista, nombre_deportista) VALUES (%s, %s);"
    
    # Executar a query com os dados extraídos
    db.execute(query, (id_deportista, nombre_deportista))
    pass
...
def generar_reporte(db):
    ...
    query = "SELECT id_deportista, nombre_deportista FROM ej01 WHERE id_deportista IN (10, 20, 30);"
